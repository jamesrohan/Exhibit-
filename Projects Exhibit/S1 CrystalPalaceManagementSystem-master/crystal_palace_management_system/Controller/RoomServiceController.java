...
public class RoomServiceController implements Initializable {
    ...
    @FXML
    private TextField orderIDCancel;
    @FXML
    ...
    public void buildData(String ReservationNumber)
    {
        ...
        try
        {
            RoomServiceTable.getColumns().clear();
...
//        return inventoryView;
    ...
    private void handleSubmit(ActionEvent event) throws IOException 
    {
        ...
        Crystal_Palace_Management_System.CPMS.insertNewRoomService(balance,
                reservationNumber, timeNow, foodId, quantity);
        buildData(reservationNumber);
    }
    ...
    @FXML
    private void handleCancelOrder(ActionEvent event) throws IOException 
    {
        if (event.getSource() == CancelOrder) 
        {
            int orderID = Integer.parseInt(orderIDCancel.getText());
            Crystal_Palace_Management_System.CPMS.deleteRoomService(orderID);
            buildData(reservationNumber);
        }
    }
