...
public class HotelServicesController implements Initializable 
{
    ...
    @FXML
    private TableView ServicesView;
    @FXML
    private Button showServices, returnToMain;
    @FXML
        ...
        try 
        {
            ...
            for (int i = 0; i < rs.getMetaData().getColumnCount(); i++)
            {
               ...
               (TableColumn.CellDataFeatures<ObservableList, String> param) {
                ...
                ServicesView.getColumns().addAll(col);
...
//        return inventoryView;
    ...
    {
        if (event.getSource() == showServices) 
        {
            buildData();
        }
    }
