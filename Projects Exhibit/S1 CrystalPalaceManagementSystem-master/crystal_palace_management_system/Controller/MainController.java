...
public class MainController implements Initializable {
    ...
    public void handleButtonAction(ActionEvent event) throws IOException 
    {
        ...
        if (event.getSource() == login) 
        {
            ...
            boolean check = 
           Crystal_Palace_Management_System.CPMS.loginCheck(username, password);
            Crystal_Palace_Management_System.empType = 
                    Crystal_Palace_Management_System.CPMS.empType;
        ...
        } else if (event.getSource() == clockOut) 
        {
            ...
            Crystal_Palace_Management_System.clockOutHour = 
                    hour.format(tempClockOut);
            Crystal_Palace_Management_System.clockOutMinute = 
                    Minute.format(tempClockOut);
            double totalMinutes = 
            Double.parseDouble(Crystal_Palace_Management_System.clockOutHour) * 60
    ...
    private void handleShowInventory(ActionEvent event) throws IOException 
    {
        if (event.getSource() == inventory) 
        {
            ...
            FXMLLoader tester = new FXMLLoader(getClass().getResource(""
                    + "/crystal_palace_management_system/View/Inventory.fxml"));
            root = tester.load();
        }
        //create a new scene with root and set the stage
        Scene scene = new Scene(root);
    ...
    public void getLoginInfo()
    {
        if ((enterUsername.getText() != null && !enterUsername.getText().isEmpty())
                && (enterPassword.getText() != null
                && !enterPassword.getText().isEmpty()))
        {
...
//                controller.clockIn.setDisable(true);
    ...
    private void handleShowRooms(ActionEvent event) throws IOException 
    {
        if (event.getSource() == Rooms) 
        {
            ...
            FXMLLoader tester = new FXMLLoader(getClass().getResource(""
                    + "/crystal_palace_management_system/View/RoomView.fxml"));
            root = tester.load();
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.show();
    ...
    @FXML
    private void handleShowTimeSheet(ActionEvent event) throws IOException 
    {
        if (event.getSource() == TimeSheet) 
        {
            stage = (Stage) TimeSheet.getScene().getWindow();
            FXMLLoader tester = new FXMLLoader(getClass().getResource(""
                    + "/crystal_palace_management_system/"
                    + "View/TimeSheetView.fxml"));
            root = tester.load();
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.show();
    ...
    @FXML
    private void handleShowServices(ActionEvent event) throws IOException
    {
        if (event.getSource() == hotelServices) 
        {
            stage = (Stage) hotelServices.getScene().getWindow();
            FXMLLoader tester = new FXMLLoader(getClass().getResource(""
                    + "/crystal_palace_management_system/View/HotelServices.fxml"));
            root = tester.load();
