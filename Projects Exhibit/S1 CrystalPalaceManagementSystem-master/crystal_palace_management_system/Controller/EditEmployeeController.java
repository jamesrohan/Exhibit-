...
public class EditEmployeeController implements Initializable {
    ...
    @FXML
    private ChoiceBox EmptypeChoice;
    @FXML
    private TextField EmpFirstName;
    @FXML
    private TextField EmpLastName;
    @FXML
    private TextField EmpMiddle;
    @FXML
    private TextField EmpNickname;
    @FXML
    ...
    private String superviserDB; 
    private String empTypeDB;
    @FXML
    private void handleEditEmployee(ActionEvent event) throws IOException 
    {
        ...
        if (event.getSource() == editEmployee) 
        {
            ...
            if (Crystal_Palace_Management_System.CPMS.UpdateEmployee(User_ID,
                    ...
                    Password, Address, JobTitle, Phone_Number,
                    SSN, DateOfBirth, Wage, Salary, Employee_Type, Start_Date,
                    End_Date, Supervisor)) 
            {
